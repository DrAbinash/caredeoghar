...
// build-installer.mjs
//
// Compiles desktop/build/installer/installer.nsi into a Windows installer .exe
// using makensis. Output: desktop/build/dist/DiagnoCenter-Setup.exe
//
// Pre-requisites (run beforehand):
//   pnpm --filter @workspace/desktop-build run build:payload
//   pnpm --filter @workspace/desktop-build run build:launcher
//   pnpm --filter @workspace/desktop-build run build:portable     # creates dist/portable/DiagnoCenter
// =============================================================================
