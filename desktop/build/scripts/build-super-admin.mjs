...
// Super Admin Portal:
//
//   desktop/build/dist/SuperAdmin-Portable.zip
//   desktop/build/dist/portable/SuperAdmin/SuperAdmin.exe
//
...
async function clonePayloadFast() {
  if (!await pathExists(SRC_PAYLOAD)) {
    throw new Error(
      ...
      `Run "pnpm --filter @workspace/desktop-build run build:payload" first.`
    );
  }
