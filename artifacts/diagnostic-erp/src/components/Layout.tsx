...
const navItems: NavEntry[] = [
  ...
  { path: "/queue", icon: Ticket, label: "Queue Tokens" },
  {
    ...
    children: [
      ...
      { path: "/radiology/archive-lifecycle", icon: Archive, label: "Archive Lifecycle" },
      { path: "/radiology/watchdog", icon: ShieldCheck, label: "Watchdog" },
      { path: "/radiology/ai-inference-settings", icon: Cpu, label: "GPU Inference" },
