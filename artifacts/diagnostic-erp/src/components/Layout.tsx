...
const navItems: NavEntry[] = [
  ...
  { path: "/queue", icon: Ticket, label: "Queue Tokens" },
  {
    ...
    children: [
      ...
      { path: "/radiology/ai-model-routing",      icon: Waypoints,    label: "AI Model Routing" },
      { path: "/radiology/structured-report-templates", icon: LayoutTemplate, label: "Structured Templates" },
      { path: "/radiology/ai-audit-log",            icon: ShieldCheck,  label: "AI Audit Log" },
      { path: "/radiology/ai-quality-scores",        icon: BarChart3,    label: "AI Quality Scores" },
      { path: "/radiology/ai-prompt-effectiveness",  icon: TrendingUp,   label: "AI Prompt Effectiveness" },
      ...
      { path: "/radiology/report-diff",            icon: FileText,     label: "Report Diff Viewer" },
      { path: "/radiology/feedback-loop-analytics", icon: TrendingUp,   label: "Feedback Loop" },
      { path: "/radiology/template-versions",      icon: LayoutTemplate, label: "Template Versions" },
      { path: "/radiology/billing-suggestions",   icon: Receipt,      label: "AI Billing Suggestions" },
      { path: "/radiology/peer-review-assignments", icon: Users,        label: "Peer Review" },
      { path: "/radiology/turnaround-times",       icon: Clock,        label: "Turnaround Time" },
      { path: "/radiology/training-data-exports",  icon: Download,     label: "Training Data Export" },
      { path: "/radiology/quality-gates",          icon: CheckCircle,  label: "Quality Gates" },
