...
async function runStartupMigrations(): Promise<void> {
  ...
  try {
    await client.query(`
      ...
      SELECT 1, 'Care Diagnostics', 'Diagnostic & Pathology Services', 'CARE DIAGNOSTICS, Subhash Chowk, Castair''s Town, Near Bajla Mahila College, Deoghar\u2013814112', 'Jayshankar Bhawan, Bilasi Town, Deoghar, Ward No. 27, Hiralal Pal Road, Deoghar, Jharkhand \u2013 814112', 'CARE.DEOGHAR@GMAIL.COM', '9973497200', '', '', null, 'Thank you for choosing our diagnostic services.', '[]', '[null,null,null,null,null,null]', false, false, 1, true, false, '', '', true, true, false, '', 1, false, false, '', false, '', false, '', false, '', false, '', '', '', '[]', '[]', 'navy', 'A5', true, true, true, 'none', false, '[]', false, NOW()
