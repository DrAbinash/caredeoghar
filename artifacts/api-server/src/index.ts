...
async function runStartupMigrations(): Promise<void> {
  ...
  try {
    await client.query(`
      ...
      INSERT INTO clinic_settings (id, name, tagline, address, email, phone, website, gstin, logo_data_url, footer_note, updated_at, form_f_test_ids, quick_test_ids, patient_photo_enabled, portal_enabled, portal_heading, portal_welcome_message, portal_allow_appointment_booking, portal_allow_profile_edit, show_tat_on_bill, bill_print_copies, qr_on_bill_enabled, online_booking_enabled, razorpay_key_id, online_booking_ledger_id, vip_queue_enabled, kiosk_enabled, kiosk_upi_vpa, kiosk_upi_name, kiosk_welcome_message, kiosk_allowed_test_ids, sidebar_theme, bill_default_paper_size, bill_show_code, bill_show_category, payu_enabled, payu_merchant_key, day_close_auto_print, commission_discount_mode, lan_only_login, lan_allowed_ips, fido2_enabled, phonepe_enabled, phonepe_merchant_id, bharatpe_enabled, bharatpe_merchant_id, cashfree_enabled, cashfree_app_id, online_booking_allowed_test_ids, session_idle_timeout_minutes, default_max_concurrent_sessions, max_failed_login_attempts, account_lockout_duration_minutes, form_f_billing_prompt, form_f_address_required, form_f_guardian_required, registered_address, online_booking_allowed_package_ids, upi_qr_image_url, upi_vpa, upi_qr_enabled, icici_enabled, icici_merchant_id, icici_aggregator_id)
      SELECT 1, 'Care Diagnostics', 'Diagnostic & Pathology Services', 'CARE DIAGNOSTICS Subhash Chowk Castair Town Near Bajla Mahila College Deoghar 814112', 'CARE.DEOGHAR@GMAIL.COM', '9973497200', '', '', null, 'Thank you for choosing our diagnostic services.', NOW(), '[]', '[null null null null null null]', false, false, '', '', true, true, false, 1, true, false, '', 1, false, '', '', '', '[]', 'navy', 'A5', true, true, false, '', true, 'none', false, '[]', false, false, '', false, '', false, '', '', '', '', '', 30, 3, 5, 30, false, true, true, 'Jayshankar Bhawan Bilasi Town Deoghar Ward No 27 Hiralal Pal Road Deoghar Jharkhand 814112', '[]', '', '', false, false, '', ''
