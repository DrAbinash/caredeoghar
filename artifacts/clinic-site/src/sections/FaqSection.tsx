...
const DEFAULT_FAQS: Faq[] = [
  ...
  { id: 2, question: "Can I book tests online and pay digitally?", answer: "Yes! You can book tests and health packages online through our Book Test section. We support secure online payment via Razorpay (cards, UPI, net banking) and PayU. You can also pay at the center in cash or card.", orderIndex: 1, enabled: true },
